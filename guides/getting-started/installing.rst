...
OS                  Archive
================== =================
**macOS**          `gyro-cli-osx-0.99.1.zip <https://artifactory.psdops.com/gyro-releases/gyro/gyro-cli-osx/0.99.1/gyro-cli-osx-0.99.1.zip>`_
**Linux**          `gyro-cli-linux-0.99.1.zip <https://artifactory.psdops.com/gyro-releases/gyro/gyro-cli-linux/0.99.1/gyro-cli-linux-0.99.1.zip>`_
**Windows**        `gyro-cli-windows-0.99.1.zip <https://artifactory.psdops.com/gyro-releases/gyro/gyro-cli-windows/0.99.1/gyro-cli-windows-0.99.1.zip>`_
================== =================
...
.. code:: shell
    ...
    $ unzip -d /usr/local/bin gyro-cli-linux-0.99.1.zip

     Archive:  gyro-cli-linux-0.99.1.zip
